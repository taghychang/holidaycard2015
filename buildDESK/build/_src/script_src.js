...
playGame.prototype = {
    ...
    create: function() {
        ...
        scoreGauge = game.add.sprite(game.world.centerX + 280, 30, 'scoreGauge');
        ...
        // ADD BARISTA
        barista = game.add.sprite(game.world.centerX, game.world.centerY - 228, 'barista');
        barista.anchor.set(0.5,0.5);
  ...
  //============================== END ===============================//
    ...
    generateCups: function() { 
        ...
        var leftXend = (game.rnd.between(530, 540));
        var midXend = (game.rnd.between(720, 730));
        var rightXend = (game.rnd.between(902, 930));

        var leftXstart = (game.rnd.between(670, 680));
        var midXstart = (game.rnd.between(720, 730));
        var rightXstart = (game.rnd.between(810, 820));
