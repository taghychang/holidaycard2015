...
demo.prototype = {
    ...
    preload: function() {
        ...
        // game.load.image("nextBtn","images/nextBtn.png");
    ...
    create: function() {
        ...
        var nextButton = game.add.button(game.world.centerX+180,780,'nextButton',nextSequence);
        // var nextButton = game.add.sprite(0,0,'nextButton');

        // ------- ASSET SPRITES ------- //
        //FIRST SEQUENCE
        var demoAsset_01 = game.add.sprite(655,350,'img_01');
        var demoAsset_02 = game.add.sprite(855,350,'img_02');
        var demoAsset_03 = game.add.sprite(850,540,'img_03');
        var demoAsset_04 = game.add.sprite(650,540,'img_04');
        var demoAsset_05 = game.add.sprite(615,690,'img_05');
        var demoAsset_06 = game.add.sprite(790,830,'img_06');
        var demoAsset_swipe = game.add.sprite(610,780,'img_swipe');
        //SECOND SEQUENCE
        var demoAsset_07 = game.add.sprite(810,240,'img_07');
        var demoAsset_08 = game.add.sprite(620,270,'img_08');
        var demoAsset_09 = game.add.sprite(750,540,'img_09');
        var demoAsset_10 = game.add.sprite(890,460,'img_10');
...
game.add.tween(demoAsset_02.scale).to({ x:1, y:1 }, 3200, Phaser.Easing.Bounce.InOut, true, 100);
var tween3 = game.add.tween(demoAsset_03).to({alpha: 1}, 600);
var tween4 = game.add.tween(demoAsset_04).to({alpha: 1}, 600);
game.add.tween(demoAsset_04.scale).to({ x:1, y:1 }, 3400, Phaser.Easing.Bounce.InOut, true, 1200);
...
tween7.chain(tween8);
game.add.tween(demoAsset_08.scale).to({ x:1, y:1 }, 2200, Phaser.Easing.Bounce.InOut, true, 100);
tween8.chain(tween9);
