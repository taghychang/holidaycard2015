...
preloader.prototype = {
    preload: function() {
        ...
        var loadSteam = game.add.image(game.world.centerX + 20, 220, 'loadSteam');
        ...
        game.load.atlas('stageSteam', 'images/stageSteam/stageSteam.png', 'images/stageSteam/stageSteam.json');
        //WIN PAGE ASSETS
        game.load.image('winPageBg', 'images/winPage/winPageBg.jpg');
...
function loadStart() {
      game.add.text(game.world.centerX - 40, 800, 'LOADING', { fill: '#ffffff' });
}
